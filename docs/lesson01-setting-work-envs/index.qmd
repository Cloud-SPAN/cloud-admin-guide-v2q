...
-   Windows Git Bash terminals --- see the [Precourse Instructions](/docs/miscellanea/precourse-instructions.qmd) section to install Git Bash.
-   Mac terminals that run the Bash shell or the Zsh shell --- see the [Precourse Instructions](/docs/miscellanea/precourse-instructions.qmd) section to install or update Bash; Bash version must be 5.0 or higher.
